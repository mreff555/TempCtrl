...
Bitfield::Bitfield(uint64_t num) { set(num); }
...
void Bitfield::clear() { this->data = 0; }

void Bitfield::operator|=(const Bitfield &rhs) { this->data |= rhs.data; }
...
uint8_t Bitfield::getBitfieldSize() const { return 8 * sizeof(data); }
